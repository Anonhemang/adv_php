    ...
    <div class="all">
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="box">
                <div class="upr">
                    <div class="imbo">
                        <img src="" alt="" class="inimg">
                        <input type="file" name="img" id="">(Image Comes Here)
                    </div>
                    <div class="all_cont">

                        <div class="title">

                            <h2><textarea name="title" id="" cols="40" rows="2"
                        ...
                        <div class="tag">
                            <h5>Tags:</h5>
                            <?php
                            foreach ($function->fetchcategory() as $category) {
                                ?>
                                <input type="checkbox" name="tag[]" value="<?php echo $category['category']; ?>" id=""><?php echo $category['category'];
                            } ?>
            ...
            <center><input type="submit" value="Add This Post" name="addpost" class="btn btn-success mt-2 mb-3 btn-lg">
        </center>
        </form>
...
if (isset($_POST['addpost'])) {
    ...
    $function->addpost($move, $img, $title, $content, $auth, $tag);
